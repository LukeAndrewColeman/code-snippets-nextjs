        ...
        {snippet && (
            <div className="p-10">
                <div className="bg-[#28394B] flex flex-col items-center p-10 rounded-xl">
                    <h5 className="mb-2 text-3xl text-[#6DC0B4] font-bold pb-2">
                    {snippet.title}
                    </h5>
                    ...
                    <div className="flex gap-3 mt-4">
                        <p className="text-sm text-[#28394B] py-1 px-3 bg-[#80afc0] rounded-full font-bold">
                        {snippet.language}
                        </p>
                    </div>
                    <div className="flex justify-end gap-3 mt-6">
                        <Link href={`/snippets/update/${snippet.id}`}>
                            <p className="text-sm text-[#28394B] py-1 px-3 bg-[#448168] hover:bg-[#5AA99E] rounded-full font-bold">
                            Edit
                            </p>
                        </Link>
