...
const UpdatePage = () => {
    ...
    return (
        <div className="container mx-auto mt-6">
            <h1 className="text-center text-3xl text-[#6DC0B4] font-bold py-4">Update Code Snippet</h1>
            <form onSubmit={handleSubmit} className="flex flex-col items-center mt-6 bg-[#28394B] p-10 rounded-xl">
                ...
                <button type="submit" className="tex-center mt-6 bg-[#448168] hover:bg-[#5AA99E] text-[#28394B] font-bold px-6 py-2 rounded-full">
                    Update Code Snippet
                </button>
