...
const DashboardPage = () => {
    ...
    const [snippetsPerPage, setSnippetsPerPage] = useState(16);
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    const uniqueLanguages = [
                        "All",
                        ...new Set(data.map((snippet) => snippet.language)),
                    ];
            ...
            <div className="mt-10 container mx-auto">
                ...
                {[
                    ...
                    <button
                        ...
                        className={`text-[#283A4C] hover:bg-[#448168] px-3 py-1 rounded-full text-sm mr-2 mt-4 font-bold ${
                            filter === language
                                ? "bg-[#448168]"
                                : "bg-[#5AA99E]"
                        }`}
